      ...
      <section id="questoes-em-jogo" className="scroll-mt-24 rounded-2xl border border-slate-300 bg-white p-3 shadow-sm dark:border-white/15 dark:bg-slate-900 md:p-5">
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm font-medium text-slate-700 dark:text-slate-300">
            Exibindo {questoesVisiveis.length} quesṭo(̵es) {activeMateria === TODAS_AS_MATERIAS ? 'misturadas de todas as mat̩rias' : activeTema ? `do tema ${activeTema}` : 'da mat̩ria selecionada'}.
          </p>
        </div>
